                        ...
                        <div class="mb-2">
                            ...
                            <div class="pl-6">
                                ...
                                <div class="mb-3">
                                    <label
                                        class="label"
                                        :for="'photo_url' + variant.id"
                                        >photo</label
                                    >
                                    <input
                                        :id="'photo_url' + variant.id"
                                        @change="
                                ...
                                >
                                    <img
                                        class="max-h-[200px] rounded-lg border border-gray-300"
                                        :src="
                                            '/storage/' +
                                            form.variants[variantIndex].color
                                                .photo_url
